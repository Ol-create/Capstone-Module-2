    ...
    comments = [
      {
        ...
        comment: 'Ohh, it looks delicius!',
      },
      {
        username: 'Diana Lucia',
        creation_date: '2022-04-22',
        comment: 'How much is that delicacy?',
      },
    ];
  }
...
const getReservationsById = (itemId) => {
  let reservations;
  if (itemId === '52819') {
    reservations = [
      {
